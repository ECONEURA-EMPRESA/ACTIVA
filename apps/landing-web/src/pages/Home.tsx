...
export const Home = () => {
    ...
    const modalConfig: Record<string, { title: string; icon: JSX.Element; content: JSX.Element }> = {
        book: {
            title: "Método Activa: El Libro",
            icon: <BookOpen className="text-[#EC008C]" size={32} />,
            content: <BookModal />
        },
        clinic: {
            title: "Reserva tu Sesión",
            icon: <HeartPulse className="text-[#EC008C]" size={32} />,
            content: <ClinicModal formStep={formStep} setFormStep={setFormStep} />
        },
        course: {
            title: "Certificación Método Activa",
            icon: <GraduationCap className="text-[#EC008C]" size={32} />,
            content: <CourseModal />
        }
    };
    ...
    const schema = {
        ...
        "url": "https://webycrm-activa.web.app",
        "logo": "https://webycrm-activa.web.app/logo-premium.png",
        ...
        "founder": {
            ...
            "image": "https://webycrm-activa.web.app/assets/aurora-profile.jpg",
